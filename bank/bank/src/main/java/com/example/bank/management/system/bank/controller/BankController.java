...
public class BankController {
    ...
    public ResponseEntity<Sbi_Bank> amt_deposit(@RequestBody Deposit deposit){
        return new ResponseEntity<>(bankService.amount_deposit(deposit),HttpStatus.PROCESSING);
    }

    @PutMapping("/profileupdate")
    public ResponseEntity<Sbi_Bank> profile_update(@RequestBody ProfileUpdation profileUpdation){
        return new ResponseEntity<>(bankService.profile_update(profileUpdation),HttpStatus.CREATED);
    }
