...
import com.example.bank.management.system.bank.exception.InsufficientBalanceException;
...
public class BankServiceImpl implements BankService{
    ...
    public Sbi_Bank profile_update(ProfileUpdation profileUpdation) {
        ...
        BigInteger phno=profileUpdation.getPh_no();
        String email=profileUpdation.getE_mail();
        sbi_bank.setPh_no(phno);
    ...
    public CurrencyRate currency_rate() {
     ...
     //   Sbi_Bank sbi_bank=new Sbi_Bank();
       // sbi_bank.setSuccess(currencyRate);
        return currencyRate;
    }
}
